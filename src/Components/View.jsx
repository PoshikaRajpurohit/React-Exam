...
const ViewRoom = () => {
  ...
  return (
    <Container className="py-4">
      <Card className="p-4 shadow-sm bg-light rounded-4">
        <Card.Body>
          <Row className="gx-5 gy-4">
            <Col xs={12} md={4} className="text-center">
              ...
              <Button variant="danger" className="w-100 fw-bold" onClick={handleBookNow}>
                Book Now
              </Button>
            </Col>
            <Col xs={12} md={8}>
              <h3 className="text-start">{room.number}</h3>
              <p className="text-muted text-start">{room.category}</p>
              <p className="text-muted text-start">{room.desc}</p>
